...
$tfi_listadvertise2->addColumn("advertise.heigh", "NUMERIC_TYPE", "heigh", "=");
...
$tso_listadvertise2->addColumn("advertise.heigh");
$tso_listadvertise2->addColumn("advertise.position");
$tso_listadvertise2->addColumn("advertise.visible");
$tso_listadvertise2->setDefault("advertise.day_update DESC");
...
// Defining List Recordset variable
$NXTSort_rsadvertise1 = "advertise.day_update DESC";
if (isset($_SESSION['sorter_tso_listadvertise2'])) {
  $NXTSort_rsadvertise1 = $_SESSION['sorter_tso_listadvertise2'];
}
mysql_select_db($database_ketnoi, $ketnoi);

$query_rsadvertise1 = "SELECT advertise.title, advertise.notes, advertise.notes_EN, advertise.file_image, advertise.fileflash, advertise.url, advertise.day_update, advertise.day_start, advertise.day_end, advertise.day_remain, advertise.width, advertise.heigh, advertise.position, advertise.visible, advertise.id_advertise FROM advertise WHERE {$NXTFilter_rsadvertise1} ORDER BY {$NXTSort_rsadvertise1}";
...
?>
  ...
  <div class="KT_tnglist">
    <form action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" method="post" id="form1">
      <div class="KT_options"> <a href="<?php echo $nav_listadvertise2->getShowAllLink(); ?>"><?php echo NXT_getResource("Show"); ?>
        <?php 
...
?>
                  <a href="<?php echo $tfi_listadvertise2->getResetFilterLink(); ?>"><?php echo NXT_getResource("Reset filter"); ?></a>
                  <?php 
  // else Conditional region2
  } else { ?>
                  <a href="<?php echo $tfi_listadvertise2->getShowFilterLink(); ?>"><?php echo NXT_getResource("Show filter"); ?></a>
                  <?php } 
      ...
      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
        <thead>
          <tr class="KT_row_order">
            ...
            <th id="title" class="KT_sorter KT_col_title <?php echo $tso_listadvertise2->getSortIcon('advertise.title'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.title'); ?>">Title</a> </th>
            <th id="notes" class="KT_sorter KT_col_notes <?php echo $tso_listadvertise2->getSortIcon('advertise.notes'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.notes'); ?>">Notes</a> </th>
            <th id="notes_EN" class="KT_sorter KT_col_notes_EN <?php echo $tso_listadvertise2->getSortIcon('advertise.notes_EN'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.notes_EN'); ?>">notes(English)</a> </th>
            <th id="file_image" class="KT_sorter KT_col_file_image <?php echo $tso_listadvertise2->getSortIcon('advertise.file_image'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.file_image'); ?>">Image</a> </th>
            <th id="fileflash" class="KT_sorter KT_col_fileflash <?php echo $tso_listadvertise2->getSortIcon('advertise.fileflash'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.fileflash'); ?>">Flash file</a> </th>
            <th id="url" class="KT_sorter KT_col_url <?php echo $tso_listadvertise2->getSortIcon('advertise.url'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.url'); ?>">Url</a> </th>
            <th id="day_update" class="KT_sorter KT_col_day_update <?php echo $tso_listadvertise2->getSortIcon('advertise.day_update'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.day_update'); ?>">Day update</a> </th>
            <th id="day_start" class="KT_sorter KT_col_day_start <?php echo $tso_listadvertise2->getSortIcon('advertise.day_start'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.day_start'); ?>">Day start</a> </th>
            <th id="day_end" class="KT_sorter KT_col_day_end <?php echo $tso_listadvertise2->getSortIcon('advertise.day_end'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.day_end'); ?>">Day end</a> </th>
            <th id="day_remain" class="KT_sorter KT_col_day_remain <?php echo $tso_listadvertise2->getSortIcon('advertise.day_remain'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.day_remain'); ?>">Day remaining</a> </th>
            <th id="width" class="KT_sorter KT_col_width <?php echo $tso_listadvertise2->getSortIcon('advertise.width'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.width'); ?>">Width</a> </th>
            <th id="heigh" class="KT_sorter KT_col_heigh <?php echo $tso_listadvertise2->getSortIcon('advertise.heigh'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.heigh'); ?>">Heigh</a> </th>
            <th id="position" class="KT_sorter KT_col_position <?php echo $tso_listadvertise2->getSortIcon('advertise.position'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.position'); ?>">Position</a> </th>
            <th id="visible" class="KT_sorter KT_col_visible <?php echo $tso_listadvertise2->getSortIcon('advertise.visible'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.visible'); ?>">Visible</a> </th>
            <th>&nbsp;</th>
          </tr>
          <?php 
          ...
          <?php if ($totalRows_rsadvertise1 > 0) { // Show if recordset not empty ?>
            <?php do { ?>
              ...
              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                ...
                <td colspan="14"><table width="100%" border="1" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="4%">Title</td>
                    <td width="96%"><div class="KT_col_title"><?php echo KT_FormatForList($row_rsadvertise1['title'], 20); ?></div></td>
                  </tr>
                  <tr>
                    <td>Notes</td>
