...
$formValidation->addField("member_name_EN", true, "text", "", "", "", "<?php echo vuilongnhaphoten;?>.");
$formValidation->addField("member_id_country", true, "numeric", "", "", "", "
<?php echo vuilongchonquequan;?>.");
...
$upd_member->addColumn("member_name_EN", "STRING_TYPE", "POST", "member_name_EN");
...
$upd_member->addColumn("member_address_EN", "STRING_TYPE", "POST", "member_address_EN");
...
$upd_member->addColumn("member_intro_short_EN", "STRING_TYPE", "POST", "member_intro_short_EN");
$upd_member->addColumn("member_intro_EN", "STRING_TYPE", "POST", "member_intro_EN");
...
<form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    ...
    <tr>
      <td><label for="member_name_EN"><?php echo hoten;?>:</label></td>
      <td><input type="text" name="member_name_EN" id="member_name_EN" value="<?php echo KT_escapeAttribute($row_rsmember['member_name_EN']); ?>" size="32" />
          <?php echo $tNGs->displayFieldHint("member_name_EN");?> <?php echo $tNGs->displayFieldError("member", "member_name_EN"); ?> </td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      <td><label for="member_address_EN"><?php echo diachi;?>:</label></td>
      <td><input type="text" name="member_address_EN" id="member_address_EN" value="<?php echo KT_escapeAttribute($row_rsmember['member_address_EN']); ?>" size="70" />
          <?php echo $tNGs->displayFieldHint("member_address_EN");?> <?php echo $tNGs->displayFieldError("member", "member_address_EN"); ?> </td>
    </tr>
    <tr>
