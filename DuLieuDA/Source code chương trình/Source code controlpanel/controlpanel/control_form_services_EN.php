...
$query_rs_services_categories = "SELECT id_services_categories, svcat_name_EN FROM services_categories WHERE svcat_visible = 1 ORDER BY svcat_sort ASC";
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          ...
          <tr>
            <td><label for="title_EN_<?php echo $cnt1; ?>">Title:</label></td>
            <td><input type="text" name="title_EN_<?php echo $cnt1; ?>" id="title_EN_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsservices['title_EN']); ?>" size="50" />
                <?php echo $tNGs->displayFieldHint("title_EN");?> <?php echo $tNGs->displayFieldError("services", "title_EN", $cnt1); ?> </td>
          </tr>
          <tr>
            <td><label for="id_services_categories_<?php echo $cnt1; ?>">Categories :</label></td>
            <td><select name="id_services_categories_<?php echo $cnt1; ?>" id="id_services_categories_<?php echo $cnt1; ?>">
              <option value="" <?php if (!(strcmp("", $row_rsservices['id_services_categories']))) {echo "selected=\"selected\"";} ?>><?php echo NXT_getResource("Select one..."); ?></option>
              <?php
do {  
?>
              <option value="<?php echo $row_rs_services_categories['id_services_categories']?>"<?php if (!(strcmp($row_rs_services_categories['id_services_categories'], $row_rsservices['id_services_categories']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rs_services_categories['svcat_name_EN']?></option>
              <?php
...
?>
          ...
          <tr>
            <td><label for="image_illustrate_<?php echo $cnt1; ?>">Image illustrate:</label></td>
            <td><input type="file" name="image_illustrate_<?php echo $cnt1; ?>" id="image_illustrate_<?php echo $cnt1; ?>" size="32" />
                <?php echo $tNGs->displayFieldError("services", "image_illustrate", $cnt1); ?>
                <?php 
...
?>            </td>
          ...
          <tr>
            <td><label for="short_describe_EN_<?php echo $cnt1; ?>">Short describe:</label></td>
            <td><input name="short_describe_EN_<?php echo $cnt1; ?>" type="text" id="short_describe_EN_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsservices['short_describe_EN']); ?>" size="100" maxlength="255" />
                <?php echo $tNGs->displayFieldHint("short_describe_EN");?> <?php echo $tNGs->displayFieldError("services", "short_describe_EN", $cnt1); ?> </td>
          </tr>
          <tr>
            <td colspan="2"><label for="content_EN_<?php echo $cnt1; ?>">Content:</label></td>
          </tr>

          <tr>
            <td colspan="2"><textarea name="content_EN_<?php echo $cnt1; ?>" id="content_EN_<?php echo $cnt1; ?>" cols="50" rows="5"><?php echo KT_escapeAttribute($row_rsservices['content_EN']); ?></textarea><script>
    ...
    ***************************************************/
    ...
    oEdit1.REPLACE("content_EN_<?php echo $cnt1; ?>");
                </script><?php echo $tNGs->displayFieldHint("content_EN");?> <?php echo $tNGs->displayFieldError("services", "content_EN", $cnt1); ?></td>
          </tr>
          <tr>
            <td>Day update:</td>
          ...
          <tr>
            <td><label for="visible_<?php echo $cnt1; ?>">Visible:</label></td>
