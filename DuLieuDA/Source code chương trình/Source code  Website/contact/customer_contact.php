...
function CheckCaptcha(&$tNG) {
	...
	$captcha->setErrorMsg(vuilongnhapmabaomattruockhigui);
...
$ins_customer_contact->registerTrigger("BEFORE", "CheckCaptcha", 10);
// Add columns
...
$ins_customer_contact->addColumn("title", "STRING_TYPE", "POST", "title_contact");
...
<form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable" style="border:0">
    <tr>
      <td><label for="company_name"><?php echo tencongty;?> :</label></td>
      <td><input type="text" name="company_name" id="company_name" value="<?php echo KT_escapeAttribute($row_rscustomer_contact['company_name']); ?>" size="50" />
          <?php echo $tNGs->displayFieldHint("company_name");?> <?php echo $tNGs->displayFieldError("customer_contact", "company_name"); ?> </td>
    </tr>
    <tr>
      <td><label for="company_address"><?php echo diachicongty;?> :</label></td>
      <td><input type="text" name="company_address" id="company_address" value="<?php echo KT_escapeAttribute($row_rscustomer_contact['company_address']); ?>" size="60" />
    ...
    <tr>
      ...
      <td><input type="text" name="member_name" id="member_name" value="<?php echo KT_escapeAttribute($row_rscustomer_contact['member_name']); ?>" size="32" />
          <?php echo $tNGs->displayFieldHint("member_name");?> <?php echo $tNGs->displayFieldError("customer_contact", "member_name"); ?> </td>
    </tr>
    <tr>
      <td><label for="id_country"><?php echo quoctich;?> :</label></td>
...
?>
    ...
    <tr>
      <td><label for="address"><?php echo diachi;?> :</label></td>
      <td><input type="text" name="address" id="address" value="<?php echo KT_escapeAttribute($row_rscustomer_contact['address']); ?>" size="60" />
    ...
    <tr>
      <td><label for="tel"><?php echo dienthoai;?> :</label></td>
    ...
    <tr>
      <td><label for="fax"><?php echo fax;?> :</label></td>
    ...
    <tr>
      <td><label for="title_contact"><?php echo vandelienhe;?> :</label></td>
      <td><input type="text" name="fax" id="fax" value="<?php echo KT_escapeAttribute($row_rscustomer_contact['title']); ?>" size="70" />
          <?php echo $tNGs->displayFieldHint("title");?> <?php echo $tNGs->displayFieldError("customer_title", "title"); ?> </td>
    </tr>
    <tr>
      <td colspan="2"><label for="content"><?php echo noidung;?> :</label></td>
      </tr>
      <tr>
      <td colspan="2"><textarea name="content" id="content" cols="70" rows="10" style="background-color:#FFFFF0; border:0;"><?php echo KT_escapeAttribute($row_rscustomer_contact['content']); ?></textarea>
          <?php echo $tNGs->displayFieldHint("content");?> <?php echo $tNGs->displayFieldError("customer_contact", "content"); ?> </td>
    </tr>
     <tr>
      <td><label for="id_contact_department"><?php echo mabaomat;?></label></td>
      <td><input type="text" name="captcha_id" id="captcha_id" value="" />
        <br />
<?php echo vuilongnhapmabaomattruockhigui;?>.<br />
<img src="<?php echo $captcha_id_obj->getImageURL("../");?>" border="0" /></td>
    </tr>
    <tr>
      <td><label for="id_contact_department"><?php echo bophanlienhe;?></label></td>
...
?>
    ...
    <tr class="KT_buttons">
      <td colspan="2"><input type="submit" name="KT_Insert1" id="KT_Insert1" value="<?php echo guilienhe;?>" />
      </td>
    </tr>
  </table>
