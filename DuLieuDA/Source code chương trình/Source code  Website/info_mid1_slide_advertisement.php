...
$query_rs_banner = "SELECT id_advertise, title, notes, notes_EN, file_image, url, width, height, position, fileflash FROM advertise WHERE position='mid1' AND (date_format(day_end,'%y%m%d') >= date_format(now(),'%y%m%d')) AND visible = 1 ORDER BY sort ASC";
...
imag[<?php echo $dem; ?>] = "uploads/advertisement/<?php echo $row_rs_banner['file_image']; ?>";
