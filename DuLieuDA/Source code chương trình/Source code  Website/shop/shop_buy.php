...
$query_rs_products = sprintf("SELECT id_products, id_procat,id_member, product_name, product_name_EN, product_image_illustrate FROM products WHERE id_member=%s AND product_type='buy' AND product_visible = 1 ORDER BY product_day_update DESC", GetSQLValueString($get_id_member_rs_products, "int"));
