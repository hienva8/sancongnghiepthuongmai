...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_capital_revenue = "SELECT id_capital_revenue, cr_name, cr_name_EN FROM capital_revenue ORDER BY sort ASC";
...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_capital_revenue1 = "SELECT id_capital_revenue, cr_name, cr_name_EN FROM capital_revenue ORDER BY sort ASC";
...
?>
        ...
        <tr>
          <td class="KT_th"><label for="company_mobile_<?php echo $cnt1; ?>">Company_mobile:</label></td>
...
?>
        ...
        <tr>
          ...
          <td><select name="company_year_foundation_<?php echo $cnt1; ?>" id="company_year_foundation_<?php echo $cnt1; ?>">
            <option value="" >--chọn--</option>
            <option value="1990" <?php if (!(strcmp(1990, KT_escapeAttribute($row_rscompany['company_year_foundation'])))) {echo "SELECTED";} ?>>1990</option>
          </select>
              <?php echo $tNGs->displayFieldError("company", "company_year_foundation", $cnt1); ?> </td>
        </tr>
        <tr>
...
do {  
?>
            <option value="<?php echo $row_rs_capital_revenue['id_capital_revenue']?>"<?php if (!(strcmp($row_rs_capital_revenue['id_capital_revenue'], $row_rscompany['company_authorized_capital']))) {echo "SELECTED";} ?>><?php echo $row_rs_capital_revenue['cr_name']?></option>
            <?php
...
do {  
?>
            <option value="<?php echo $row_rs_capital_revenue1['id_capital_revenue']?>"<?php if (!(strcmp($row_rs_capital_revenue1['id_capital_revenue'], $row_rscompany['company_yearly_revenue']))) {echo "SELECTED";} ?>><?php echo $row_rs_capital_revenue1['cr_name']?></option>
            <?php
...
do {  
?>
            <option value="<?php echo $row_rs_import_export1['id_import_export']?>"<?php if (!(strcmp($row_rs_import_export1['id_import_export'], $row_rscompany['company_export_rates']))) {echo "SELECTED";} ?>><?php echo $row_rs_import_export1['content']?></option>
            <?php
...
?>
        ...
        <tr>
          <td class="KT_th"><label for="company_main_markets_orther_<?php echo $cnt1; ?>">Company_main_markets_orther:</label></td>
        ...
        <tr>
          <td class="KT_th"><label for="company_info_<?php echo $cnt1; ?>">Company_info:</label></td>
        ...
        <tr>
          <td class="KT_th"><label for="company_info_EN_<?php echo $cnt1; ?>">company_info_EN:</label></td>
        ...
        <tr>
          <td class="KT_th">Company_day_update:</td>
          <td><?php echo KT_formatDate($row_rscompany['company_day_update']); ?></td>
        </tr>
        <tr>
          <td class="KT_th"><label for="company_visible_<?php echo $cnt1; ?>">Company_visible:</label></td>
