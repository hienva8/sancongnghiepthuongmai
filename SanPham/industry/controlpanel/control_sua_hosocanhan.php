  ...
  <tr>
    ...
    <tr>
      ...
      <td><input type="file" name="mbpro_avatar" id="mbpro_avatar" size="32" />
          <?php echo $tNGs->displayFieldError("member_profile", "mbpro_avatar"); ?> <?php 
// Show If File Exists (region1)
if (tNG_fileExists("../uploads/avatar/{SESSION.kt_login_id}/", "{rsmember_profile.mbpro_avatar}")) {
?>
...
?></td>
    ...
    <tr>
      <td><label for="mbpro_id_industry"><?php echo congnghiep;?>:</label></td>
...
?>
    ...
    <tr>
      ...
      <td><input type="text" name="mbpro_main_product" id="mbpro_main_product" value="<?php echo KT_escapeAttribute($row_rsmember_profile['mbpro_main_product']); ?>" size="32" />
    ...
    <tr>
      ...
      <td><input type="text" name="mbpro_main_markets_orther" id="mbpro_main_markets_orther" value="<?php echo KT_escapeAttribute($row_rsmember_profile['mbpro_main_markets_orther']); ?>" size="32" />
    ...
    <tr>
      ...
      <td><input type="text" name="mbpro_shortinfo" id="mbpro_shortinfo" value="<?php echo KT_escapeAttribute($row_rsmember_profile['mbpro_shortinfo']); ?>" size="32" />
          <?php echo $tNGs->displayFieldHint("mbpro_shortinfo");?> <?php echo $tNGs->displayFieldError("member_profile", "mbpro_shortinfo"); ?> </td>
    </tr>
    <tr>
      <td colspan="2"><label for="mbpro_info"><?php echo gioithieu;?> :</label></td>
      </tr>
      <tr>
      <td colspan="2"><textarea name="mbpro_info" id="mbpro_info" cols="50" rows="5"><?php echo KT_escapeAttribute($row_rsmember_profile['mbpro_info']); ?></textarea>
       <script>
