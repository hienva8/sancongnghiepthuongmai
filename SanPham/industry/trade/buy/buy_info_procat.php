...
$query_rs_products = sprintf("SELECT products.id_products,products.id_procat,products.product_name,products.product_name_EN,products.product_short_describe,products.product_short_describe_EN,products.product_image_illustrate,products.id_member,member.member_kind,country.country_name,country.country_name_EN,country.country_image_illustrate FROM (products LEFT JOIN member ON products.id_member=member.id_member),country WHERE products.product_type='buy' AND products.id_procat=%s AND member.member_id_country=country.id_country", GetSQLValueString($get_procat_rs_products, "int"));
