...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_products = sprintf("SELECT id_products FROM products WHERE id_prosubcat1 = 123456789 AND id_procat=%s AND product_type='buy' ORDER BY product_name ASC", GetSQLValueString($get_id_procat_rs_products, "int"));
