...
?>
<div class="bor_1">
        	<img src="../../Interface/home-1.jpg" width="16" height="16" />&nbsp;<span class="st_1"><a href="../../index.php">Home</a>&nbsp;<b> ></b>&nbsp;<a href="#"> <?php echo chaomua;?></a>&nbsp;<b> ></b>&nbsp;<a href="index.php?mod=psc1&ipc=<?php echo $row_rs_prosubcat3['id_procat'];?>"><?php echo $row_rs_prosubcat3['procat_name']; ?></a>&nbsp;<b> ></b>&nbsp;<a href="index.php?mod=psc2&ipc=<?php echo $row_rs_prosubcat3['id_procat'];?>&ipsc1=<?php echo $row_rs_prosubcat3['id_prosubcat1'];?>"><?php echo $row_rs_prosubcat3['prosubcat1_name']; ?></a>&nbsp;<b> ></b>&nbsp;<a href="index.php?mod=psc3&ipc=<?php echo $row_rs_prosubcat3['id_procat'];?>&ipsc1=<?php echo $row_rs_prosubcat3['id_prosubcat1']; ?>&ipsc2=<?php echo $row_rs_prosubcat3['id_prosubcat2']; ?>"><?php echo $row_rs_prosubcat3['prosubcat2_name']; ?></a>&nbsp;<b> ></b>&nbsp;</span><?php echo $row_rs_prosubcat3['prosubcat3_name']; ?></div>
<div class="cates"></div>
<?php
