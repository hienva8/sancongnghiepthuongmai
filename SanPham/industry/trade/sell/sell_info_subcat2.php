...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_products = sprintf("SELECT id_products FROM products WHERE id_prosubcat1 = 123456789 AND id_procat=%s AND  id_prosubcat2=%s AND product_type='sell' ORDER BY product_name ASC", GetSQLValueString($get_id_procat_rs_products, "int"),GetSQLValueString($get_id_prosubcat2_rs_products, "int"));
...
<div class="bor_1">
        	<img src="../../Interface/home-1.jpg" width="16" height="16" />&nbsp;<span class="st_1"><a href="../../index.php">Home</a>&nbsp;<b> ></b>&nbsp;<a href="#"> <?php echo chaomua;?></a>&nbsp;<b> ></b>&nbsp;<a href="index.php?mod=psc1&ipc=<?php echo $row_rs_prosubcat1['id_procat']; ?>"><?php echo $row_rs_prosubcat1['procat_name']; ?></a>&nbsp;<b> ></b>&nbsp;<?php echo $row_rs_prosubcat1['prosubcat1_name']; ?></span></div>
<div class="cates">
        	<fieldset>            
