...
$mxiObj->IncludeStatic("", "sell_info_homepage.php", "", "", "");
$mxiObj->IncludeStatic("psc1", "sell_info_homepage1.php", "", "", "");
$mxiObj->IncludeStatic("psc2", "sell_info_homepage2.php", "", "", "");
$mxiObj->IncludeStatic("psc3", "sell_info_homepage3.php", "", "", "");
$mxiObj->IncludeStatic("psc4", "sell_info_homepage4.php", "", "", "");
...
?>
 <?php
  mxi_includes_start("sell_info.php");
  require(basename("sell_info.php"));
  mxi_includes_end();
?>
 <?php
  mxi_includes_start("sell_slide.php");
  require(basename("sell_slide.php"));
  mxi_includes_end();
?>
 <?php
