...
$mxiObj->IncludeStatic("", "business_info_homepage.php", "", "", "");
$mxiObj->IncludeStatic("business", "business_info_homepage1.php", "", "", "");
...
?>
 <?php
  mxi_includes_start("business_info.php");
  require(basename("business_info.php"));
  mxi_includes_end();
?>
<?php
  mxi_includes_start("business_slide.php");
  require(basename("business_slide.php"));
  mxi_includes_end();
?>
 <?php
