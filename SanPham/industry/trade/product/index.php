...
$mxiObj->IncludeStatic("", "product_info_contain_homepage.php", "", "", "");
$mxiObj->IncludeStatic("psc1", "product_info_contain_homepage1.php", "", "", "");
$mxiObj->IncludeStatic("psc2", "product_info_contain_homepage2.php", "", "", "");
$mxiObj->IncludeStatic("psc3", "product_info_contain_homepage3.php", "", "", "");
$mxiObj->IncludeStatic("psc4", "product_info_contain_homepage4.php", "", "", "");
...
?>
 <?php
  mxi_includes_start("product_info.php");
  require(basename("product_info.php"));
  mxi_includes_end();
?>
 <?php
  mxi_includes_start("product_slide.php");
  require(basename("product_slide.php"));
  mxi_includes_end();
?>
 <?php
