...
$get_id_member_rs_thongtinlienhe = "1";
if (isset($_GET['imb'])) {
  $get_id_member_rs_thongtinlienhe = $_GET['imb'];
}
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_thongtinlienhe = sprintf("SELECT *,name,position_name FROM ((contact_information LEFT JOIN contact_department ON ct_info_department=id_contact_department)LEFT JOIN position ON ct_info_position=id_position) WHERE ct_info_id_member =%s", GetSQLValueString($get_id_member_rs_thongtinlienhe, "int"));
...
<div id="info_company">
    ...
    <?php if($totalRows_rs_thongtinlienhe !=0) {?>
  <div id="info1">
    ...
    <?php }else{?>
<div> <?php echo hienchuacothongtinlienhe;?></div>
<?php } ?>
    </fieldset>
</div>
