...
$query_rs_products = sprintf("SELECT id_products, id_procat,id_member, product_name, product_name_EN, product_image_illustrate FROM products WHERE id_member=%s AND product_type='sell' AND product_visible = 1 ORDER BY product_day_update DESC", GetSQLValueString($get_id_member_rs_products, "int"));
...
?>
                  <td><a href="business/index.php?mod=detail&amp;ipc=<?php echo $row_rs_products['id_procat'];?>&amp;ip=<?php echo $row_rs_products['id_products'];?>&amp;imb=<?php echo $get_id_member_rs_products;?>"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" border="0" />
...
?>
              ...
              <tr>
                <?php if ($totalRows_rs_products == 0) { // Show if recordset empty ?>
                  <td><?php echo hienchuacoloichao;?></td>
