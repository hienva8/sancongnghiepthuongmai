...
$query_rsadvertise1 = "SELECT advertise.title, advertise.notes, advertise.notes_EN, advertise.file_image, advertise.fileflash, advertise.url, advertise.day_update, advertise.day_start, advertise.day_end, advertise.day_remain, advertise.width, advertise.height, advertise.position, advertise.visible, advertise.id_advertise FROM advertise WHERE {$NXTFilter_rsadvertise1} ORDER BY {$NXTSort_rsadvertise1}";
      ...
      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
        <thead>
          <tr class="KT_row_order">
            ...
            <th id="heigh" class="KT_sorter KT_col_heigh <?php echo $tso_listadvertise2->getSortIcon('advertise.height'); ?>"> <a href="<?php echo $tso_listadvertise2->getSortLink('advertise.height'); ?>">Heigh</a> </th>
