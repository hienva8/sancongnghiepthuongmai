...
<body>
<div class="logo">
    	<center><?php if($row_rs_member['member_vip']==1){?><img src="../interface/VIP_logo.gif" />
        <?php }else{ ?>
        <img src="../interface/logo_freemember.gif" width="220px" />
        <?php }?>
    	</center>
    </div>
<div class="business">
...
<div><a href="<?php echo member_VIP($row_rs_member['member_kind']);?>/index.php?mod=compinfo&amp;imb=<?php echo $get_id_member_rs_member;?>"><?php echo congty;?></a></div>
...
<div><a href="<?php echo member_VIP($row_rs_member['member_kind']);?>/index.php?mod=contact&imb=<?php echo $get_id_member_rs_member;?>"><?php echo lienhe;?></a></div>
</div>
	</div>
	<center><img src="../interface/khung_2_1.jpg" /></center>
</div>
</body>
