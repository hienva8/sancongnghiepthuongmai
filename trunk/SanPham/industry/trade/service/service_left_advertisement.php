<?php 
$query_rs_ad = "SELECT id_advertise,title,notes,notes_EN,file_image,fileflash,url,width,height,position FROM advertise WHERE (date_format(day_end,'%y%m%d') >= date_format(now(),'%y%m%d')) AND position='product' AND visible=1 Order By sort ASC";
