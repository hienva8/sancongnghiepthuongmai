...
?>
<?php
  mxi_includes_start("control_them_thongtindoanhnghiep_EN.php");
  require(basename("control_them_thongtindoanhnghiep_EN.php"));
  mxi_includes_end();
?>
<?php }?>
<?php 
...
?>
<?php
  mxi_includes_start("control_sua_thongtindoanhnghiep_EN.php");
  require(basename("control_sua_thongtindoanhnghiep_EN.php"));
  mxi_includes_end();
?>
<?php }?>
<?php } else {
