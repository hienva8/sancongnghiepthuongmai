...
$mxiObj->IncludeStatic("ls", "control_list_sell.php", "", "", "");
$mxiObj->IncludeStatic("fs", "control_tab_form_sell.php", "", "", "");
$mxiObj->IncludeStatic("dels", "control_list_delete.php", "", "", "");
$mxiObj->IncludeStatic("lb", "control_list_buy.php", "", "", "");
$mxiObj->IncludeStatic("fb", "control_tab_form_buy.php", "", "", "");
