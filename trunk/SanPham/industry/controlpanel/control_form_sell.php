...
$ins_products->registerTrigger("END", "Trigger_Default_Redirect", 99, "index.php?mod=ls");
...
$upd_products->registerTrigger("END", "Trigger_Default_Redirect", 99, "index.php?mod=ls");
...
$del_products->registerTrigger("END", "Trigger_Default_Redirect", 99, "index.php?mod=ls");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="100"><label for="product_name_<?php echo $cnt1; ?>">Tên sản phẩm:</label></td>
        <td><input type="text" name="product_name_<?php echo $cnt1; ?>" id="product_name_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsproducts['product_name']); ?>" size="50" maxlength="100" />
          ...
          <tr>
            <td width="100"><label for="id_procat_<?php echo $cnt1; ?>">Danh mục chính:</label></td>
            <td><select name="id_procat_<?php echo $cnt1; ?>" id="id_procat_<?php echo $cnt1; ?>">
              <option value="" <?php if (!(strcmp("", $row_rsproducts['id_procat']))) {echo "selected=\"selected\"";} ?>><?php echo NXT_getResource("Select one..."); ?></option>
              <?php
do {  
...
?>
          ...
          <tr>
            <td width="100"><label for="id_prosubcat1_<?php echo $cnt1; ?>">Danh mục con 1:</label></td>
          ...
          <tr>
            <td width="100"><label for="id_prosubcat2_<?php echo $cnt1; ?>">Danh mục con 2:</label></td>
          ...
          <tr>
            <td width="100"><label for="id_prosubcat3_<?php echo $cnt1; ?>">Danh mục con 3:</label></td>
          ...
          <tr>
            <td width="100"><label for="id_country_<?php echo $cnt1; ?>">Quốc gia:</label></td>
...
?>
          ...
          <tr>
            <td width="100"><label for="product_image_illustrate_<?php echo $cnt1; ?>">Hình minh họa:</label></td>
...
?></td>
          ...
          <tr>
            <td width="100"><label for="product_short_describe_<?php echo $cnt1; ?>">Mô tả ngắn:</label></td>
 ...
 <script>
    ...
    ***************************************************/
    ...
    oEdit1.REPLACE("product_content_<?php echo $cnt1; ?>");
          ...
          <tr>
            <td width="100"><label for="product_reference_price_<?php echo $cnt1; ?>">Giá tham khảo:</label></td>
        <td><input type="text" name="product_reference_price_<?php echo $cnt1; ?>" id="product_reference_price_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsproducts['product_reference_price']); ?>" size="20" maxlength="20" />
              ...
              <label for="product_rates_<?php echo $cnt1; ?>"><option value=""><?php echo NXT_getResource("Select one..."); ?></option></label>
              <?php 
do {  
?>
...
?>
          ...
          <tr>
            <td width="100"><label for="product_unit_<?php echo $cnt1; ?>">Đơn vị tính:</label></td>
          ...
          <tr>
            <td width="100"><label for="product_type_<?php echo $cnt1; ?>">Loại sản phẩm:</label></td>
            <td><select name="product_type_<?php echo $cnt1; ?>" id="product_type_<?php echo $cnt1; ?>">
              <option value="product" <?php if (!(strcmp("product", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?>>Sản phẩm</option>
              <option value="sell" selected="selected" <?php if (!(strcmp("sell", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?>>Chào bán</option>
              <option value="buy" <?php if (!(strcmp("buy", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?>>Chào mua</option>
            </select>
                <?php echo $tNGs->displayFieldError("products", "product_type", $cnt1); ?> </td>
          </tr>
          <tr>
	<td width="100"><label>Phương thức thanh toán:</label></td>
	<td>
...
?>
          ...
          <tr>
            <td width="100"><label for="product_payment_methods_orther_<?php echo $cnt1; ?>">Phương thức thanh toán khác:</label></td>
        <td><input type="text" name="product_payment_methods_orther_<?php echo $cnt1; ?>" id="product_payment_methods_orther_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsproducts['product_payment_methods_orther']); ?>" size="100" maxlength="255" />
          ...
          <tr>
            <td width="100"><label for="product_showroom_<?php echo $cnt1; ?>">Phòng trưng bày:</label></td>
        <td><input  <?php if (!(strcmp(KT_escapeAttribute($row_rsproducts['product_showroom']),"1"))) {echo "checked";} ?> type="checkbox" name="product_showroom_<?php echo $cnt1; ?>" id="product_showroom_<?php echo $cnt1; ?>" value="1" />
          ...
          <tr>
            <td width="100"><label for="product_visible_<?php echo $cnt1; ?>">Ẩn/Hiện:</label></td>
