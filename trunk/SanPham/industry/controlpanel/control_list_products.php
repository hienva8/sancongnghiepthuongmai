...
$query_rs_products = sprintf("SELECT id_products,id_member,product_name,product_name_EN, product_image_illustrate, product_day_update FROM products WHERE id_member = %s AND product_type='product' ORDER BY product_day_update DESC", GetSQLValueString($session_member_rs_products, "int"));
