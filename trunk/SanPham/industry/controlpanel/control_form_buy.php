...
$formValidation->addField("product_name", true, "text", "", "", "", "Vui lòng nhập tên sản phẩm.");
$formValidation->addField("id_procat", true, "numeric", "", "", "", "Vui lòng chọn danh mục sản phẩm");
$formValidation->addField("product_rates", true, "text", "", "", "", "Vui lòng chọn tỷ giá.");
$formValidation->addField("product_reference_price", false, "text", "phone", "", "", "Vui lòng nhập số");
...
$query_rs_procat = "SELECT id_procat, procat_name FROM procat WHERE visible = 1 ORDER BY sort ASC";
...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_prosubcat1 = "SELECT id_prosubcat1, id_procat, prosubcat1_name FROM prosubcat1 WHERE visible = 1 ORDER BY sort ASC";
...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_prosubcat2 = "SELECT id_prosubcat2, id_procat, id_prosubcat1, prosubcat2_name FROM prosubcat2 WHERE visible = 1 ORDER BY sort ASC";
...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_prosubcat3 = "SELECT id_prosubcat3, id_procat, id_prosubcat1, id_prosubcat2, prosubcat3_name FROM prosubcat3 WHERE visible = 1 ORDER BY sort ASC";
...
$ins_products->registerTrigger("END", "Trigger_Default_Redirect", 99, "index.php?mod=lb");
...
$upd_products->registerTrigger("END", "Trigger_Default_Redirect", 99, "index.php?mod=lb");
...
$del_products->registerTrigger("END", "Trigger_Default_Redirect", 99, "index.php?mod=lb");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="100"><label for="product_name_<?php echo $cnt1; ?>"><?php echo tensanpham;?>:</label></td>
        <td><input type="text" name="product_name_<?php echo $cnt1; ?>" id="product_name_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsproducts['product_name']); ?>" size="50" maxlength="100" />
                <?php echo $tNGs->displayFieldHint("product_name");?> <?php echo $tNGs->displayFieldError("products", "product_name", $cnt1); ?> </td>
          </tr>
          <tr>
            <td width="100"><label for="id_procat_<?php echo $cnt1; ?>"><?php echo danhmucchinh;?>:</label></td>
            <td><select name="id_procat_<?php echo $cnt1; ?>" id="id_procat_<?php echo $cnt1; ?>">
              <option value="" <?php if (!(strcmp("", $row_rsproducts['id_procat']))) {echo "selected=\"selected\"";} ?>><?php echo NXT_getResource(chon); ?></option>
              <?php
do {  
?><option value="<?php echo $row_rs_procat['id_procat']?>"<?php if (!(strcmp($row_rs_procat['id_procat'], $row_rsproducts['id_procat']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rs_procat['procat_name']?></option>
                <?php
...
?>
          ...
          <tr>
            <td width="100"><label for="id_prosubcat1_<?php echo $cnt1; ?>"><?php echo danhmuccon;?>1:</label></td>
            <td><select name="id_prosubcat1_<?php echo $cnt1; ?>" id="id_prosubcat1_<?php echo $cnt1; ?>" wdg:subtype="DependentDropdown" wdg:type="widget" wdg:recordset="rs_prosubcat1" wdg:displayfield="prosubcat1_name" wdg:valuefield="id_prosubcat1" wdg:fkey="id_procat" wdg:triggerobject="id_procat_<?php echo $cnt1; ?>" wdg:selected="<?php echo $row_rsproducts['id_prosubcat1'] ?>">
              <option value=""><?php echo NXT_getResource(chon); ?></option>
            </select>
                <?php echo $tNGs->displayFieldError("products", "id_prosubcat1", $cnt1); ?> </td>
          </tr>
          <tr>
            <td width="100"><label for="id_prosubcat2_<?php echo $cnt1; ?>"><?php echo danhmuccon;?>2:</label></td>
            <td><select name="id_prosubcat2_<?php echo $cnt1; ?>" id="id_prosubcat2_<?php echo $cnt1; ?>" wdg:subtype="DependentDropdown" wdg:type="widget" wdg:recordset="rs_prosubcat2" wdg:displayfield="prosubcat2_name" wdg:valuefield="id_prosubcat2" wdg:fkey="id_prosubcat1" wdg:triggerobject="id_prosubcat1_<?php echo $cnt1; ?>" wdg:selected="<?php echo $row_rsproducts['id_prosubcat2'] ?>">
              <option value=""><?php echo NXT_getResource(chon); ?></option>
            </select>
                <?php echo $tNGs->displayFieldError("products", "id_prosubcat2", $cnt1); ?> </td>
          </tr>
          <tr>
            <td width="100"><label for="id_prosubcat3_<?php echo $cnt1; ?>"><?php echo danhmuccon;?>3:</label></td>
            <td><select name="id_prosubcat3_<?php echo $cnt1; ?>" id="id_prosubcat3_<?php echo $cnt1; ?>" wdg:subtype="DependentDropdown" wdg:type="widget" wdg:recordset="rs_prosubcat3" wdg:displayfield="prosubcat3_name" wdg:valuefield="id_prosubcat3" wdg:fkey="id_prosubcat2" wdg:triggerobject="id_prosubcat2_<?php echo $cnt1; ?>" wdg:selected="<?php echo $row_rsproducts['id_prosubcat3'] ?>">
              <option value=""><?php echo NXT_getResource(chon); ?></option>
            </select>
                <?php echo $tNGs->displayFieldError("products", "id_prosubcat3", $cnt1); ?> </td>
          </tr>
          <tr>
            <td width="100"><label for="id_country_<?php echo $cnt1; ?>"><?php echo quocgia;?>:</label></td>
            <td><select name="id_country_<?php echo $cnt1; ?>" id="id_country_<?php echo $cnt1; ?>">
              <option value=""><?php echo NXT_getResource(chon); ?></option>
              <?php 
do {  
?>
              <option value="<?php echo $row_rs_country['id_country']?>"<?php if (!(strcmp($row_rs_country['id_country'], $row_rsproducts['id_country']))) {echo "SELECTED";} ?>><?php echo $row_rs_country['country_name']?></option>
              <?php
...
?>
          ...
          <tr>
            <td width="100"><label for="product_image_illustrate_<?php echo $cnt1; ?>"><?php echo hinhminhhoa;?>:</label></td>
        <td><input type="file" name="product_image_illustrate_<?php echo $cnt1; ?>" id="product_image_illustrate_<?php echo $cnt1; ?>" size="32" />
                <?php echo $tNGs->displayFieldError("products", "product_image_illustrate", $cnt1); ?> <?php 
...
?></td>
          ...
          <tr>
            <td width="100"><label for="product_short_describe_<?php echo $cnt1; ?>"><?php echo motangan;?>:</label></td>
        <td><input type="text" name="product_short_describe_<?php echo $cnt1; ?>" id="product_short_describe_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsproducts['product_short_describe']); ?>" size="100" maxlength="255" />
          ...
          <tr><td colspan="2"><?php echo noidung;?>:</td>
          </tr>
          <tr>
            <td colspan="2"><textarea name="product_content_<?php echo $cnt1; ?>" id="product_content_<?php echo $cnt1; ?>" cols="50" rows="5"><?php echo KT_escapeAttribute($row_rsproducts['product_content']); ?></textarea>
 <script>
    ...
    ***************************************************/
    ...
    oEdit1.REPLACE("product_content_<?php echo $cnt1; ?>");
          </script>
                <?php echo $tNGs->displayFieldHint("product_content");?> <?php echo $tNGs->displayFieldError("products", "product_content", $cnt1); ?> </td>
          </tr>
          <tr>
            <td width="100"><label for="product_reference_price_<?php echo $cnt1; ?>"><?php echo giathamkhao;?>:</label></td>
        <td><input type="text" name="product_reference_price_<?php echo $cnt1; ?>" id="product_reference_price_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsproducts['product_reference_price']); ?>" size="20" maxlength="20" />
                 <?php echo $tNGs->displayFieldError("products", "product_reference_price", $cnt1); ?> &nbsp;&nbsp;<select name="product_rates_<?php echo $cnt1; ?>" id="product_rates_<?php echo $cnt1; ?>">
              <label for="product_rates_<?php echo $cnt1; ?>"><option value=""><?php echo NXT_getResource(chon); ?></option></label>
              <?php 
do {  
?>
...
?>
          ...
          <tr>
            <td width="100"><label for="product_unit_<?php echo $cnt1; ?>"><?php echo donvitinh;?>:</label></td>
          ...
          <tr>
            <td width="100"><label for="product_type_<?php echo $cnt1; ?>"><?php echo loaisanpham;?>:</label></td>
            <td><select name="product_type_<?php echo $cnt1; ?>" id="product_type_<?php echo $cnt1; ?>">
              <option value="product" <?php if (!(strcmp("product", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?>><?php echo sanpham;?></option>
              <option value="sell" <?php if (!(strcmp("sell", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?>>Chào bán</option>
              <option value="buy" <?php if (!(strcmp("buy", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?> selected="selected">Chào mua</option>
            </select>
                <?php echo $tNGs->displayFieldError("products", "product_type", $cnt1); ?> </td>
          </tr>
          <tr>
	<td width="100"><label><?php echo phuongthucthanhtoan;?>:</label></td>
	<td>
...
?>
				...
				<td>
					<input id="mtm_<?php echo $row_rspayment_methods['id_payment_methods']; ?>_<?php echo $cnt1; ?>" name="mtm_<?php echo $row_rspayment_methods['id_payment_methods']; ?>_<?php echo $cnt1; ?>" type="checkbox" value="1" <?php if ($row_rspayment_methods['id_products'] != "") {?> checked<?php }?> />				</td>
				<td>
					<label for="mtm_<?php echo $row_rspayment_methods['id_payment_methods']; ?>_<?php echo $cnt1; ?>"><?php echo $row_rspayment_methods['methods_name']; ?></label>				</td>
<?php
	$cnt2++;
	if ($cnt2%3 == 0) {
		echo "</tr><tr>";
...
?>
          ...
          <tr>
            <td width="100"><label for="product_payment_methods_orther_<?php echo $cnt1; ?>"><?php echo phuongthucthanhtoankhac;?>:</label></td>
        <td><input type="text" name="product_payment_methods_orther_<?php echo $cnt1; ?>" id="product_payment_methods_orther_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsproducts['product_payment_methods_orther']); ?>" size="100" maxlength="255" />
          ...
          <tr>
            <td width="100"><label for="product_showroom_<?php echo $cnt1; ?>"><?php echo phongtrungbay;?>:</label></td>
        <td><input  <?php if (!(strcmp(KT_escapeAttribute($row_rsproducts['product_showroom']),"1"))) {echo "checked";} ?> type="checkbox" name="product_showroom_<?php echo $cnt1; ?>" id="product_showroom_<?php echo $cnt1; ?>" value="1" />
          ...
          <tr>
            <td width="100"><label for="product_visible_<?php echo $cnt1; ?>"><?php echo anhien;?>:</label></td>
      ...
      // else Conditional region1
            ...
            <div class="KT_operations">
              <input type="submit" name="KT_Insert1" value="<?php echo NXT_getResource(coppyphienban); ?>" onclick="nxt_form_insertasnew(this, 'id_products')" />
            </div>
