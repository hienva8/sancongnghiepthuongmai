...
$mxiObj->IncludeStatic("", "service_info_homepage.php", "", "", "");
$mxiObj->IncludeStatic("svcat", "service_info_homepage1.php", "", "", "");
...
?>
 <?php
  mxi_includes_start("service_info.php");
  require(basename("service_info.php"));
  mxi_includes_end();
?>
 <?php
  mxi_includes_start("service_slide.php");
  require(basename("service_slide.php"));
  mxi_includes_end();
?>
 <?php
