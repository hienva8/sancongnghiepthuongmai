...
$query_rs_products = "SELECT products.id_products,id_procat,products.id_member,products.product_name,products.product_name_EN,products.product_short_describe,products.product_short_describe_EN,products.product_image_illustrate,products.id_member,member.member_kind,country.country_name,country.country_name_EN,country.country_image_illustrate FROM ((products LEFT JOIN member ON products.id_member=member.id_member)LEFT JOIN country ON products.id_country=country.id_country) WHERE products.product_type='buy'";
...
$id_hinh =$row_rs_products["id_products"]; 
...
<h2><a href="../../shop/<?php  echo member_VIP($row_rs_products['member_kind']);?>/index.php?mod=detail&imb=<?php echo $row_rs_products["id_member"];?>&amp;ipc=<?php echo $row_rs_products['id_procat'];?>&ip=<?php echo $row_rs_products['id_products'];?>"><?php echo $row_rs_products['product_name'];?></a></h2>
            <label><?php echo $row_rs_products['product_short_describe'].$row_rs_products['member_kind'];?></label>
        </div>
        <div class="c-info">
                  <h2><a href="../../shop/<?php  echo member_VIP($row_rs_products['member_kind']);?>/index.php?mod=shop&imb=<?php echo $row_rs_products['id_member'];?>"><?php echo $row_rs_company["company_name"];?></a></h2>
                    ...
                    <div class="but"><a href="../../shop/<?php  echo member_VIP($row_rs_products['member_kind']);?>/index.php?mod=contact&imb=<?php echo $row_rs_products["id_member"];?>&amp;ip=<?php echo $row_rs_products['id_products']; ?>"><input type="image"  src="../../Interface/contact.jpg" title="contact"/></a></div>
        </div>                    
      </div>
  </div>
