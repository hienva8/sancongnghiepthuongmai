...
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_products = sprintf("SELECT id_products FROM products WHERE id_prosubcat1 = 123456789 AND id_procat=%s AND product_type='product' ORDER BY product_name ASC", GetSQLValueString($get_id_procat_rs_products, "int"));
...
<div class="bor_1">
        	<img src="../../Interface/home-1.jpg" width="16" height="16" />&nbsp;<span class="st_1"><a href="../../index.php">Home</a>&nbsp;<b> ></b>&nbsp;<a href="#"> <?php echo sanpham;?></a>&nbsp;<b> ></b>&nbsp;<?php echo $row_rs_procat['procat_name'];?></span>
</div>
<div class="cates">
