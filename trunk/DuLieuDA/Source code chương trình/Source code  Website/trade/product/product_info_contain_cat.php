...
<?php 
$query_rs_procat = "SELECT id_procat,procat_name, procat_name_EN FROM procat Order By sort";
...
?>
<?php 
$query_rs_products = "SELECT product_name, product_name_EN,id_procat FROM products WHERE id_procat = 123456789 AND product_type='product'";
...
?>
<div class="bor_1">
        	<img src="../../Interface/home-1.jpg" width="16" height="16" />&nbsp;<span class="st_1"><a href="../../index.php">Home</a>&nbsp;<b> ></b>&nbsp;<a href="#"> <?php echo sanpham;?></a></span></div>
<div class="cates">
<?php if($totalRows_rs_procat>0){?>
    ...
    <?php do { 
			$i++;
	      ?>
						<td><img src="../../Interface/icon_2.jpg" width="5" height="9" /><a href="index.php?mod=psc1&ipc=<?php echo $row_rs_procat['id_procat'];?>"><?php echo $row_rs_procat['procat_name'];?></a><span class="number">
    <?php if($totalRows_rs_procat>0){?>
