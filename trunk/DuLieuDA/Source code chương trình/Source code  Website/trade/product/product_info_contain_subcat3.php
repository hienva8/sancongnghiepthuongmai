...
$get_id_prosubcat3_rs_products = "1";
if (isset($_GET['ipsc3'])) {
  $get_id_prosubcat3_rs_products = $_GET['ipsc3'];
}
mysql_select_db($database_ketnoi, $ketnoi);
$query_rs_products = sprintf("SELECT id_products FROM products WHERE id_prosubcat1 = 123456789 AND id_procat=%s AND id_prosubcat2=%s AND id_prosubcat3=%s AND product_type='product' ORDER BY product_name ASC", GetSQLValueString($get_id_procat_rs_products, "int"),GetSQLValueString($get_id_prosubcat2_rs_products, "int"),GetSQLValueString($get_id_prosubcat3_rs_products, "int"));
...
<div class="bor_1">
        	<img src="../../Interface/home-1.jpg" width="16" height="16" />&nbsp;<span class="st_1"><a href="../../index.php">Home</a>&nbsp;<b> ></b>&nbsp;<a href="#"> <?php echo sanpham;?></a>&nbsp;<b> ></b>&nbsp;<a href="index.php?mod=psc1&ipc=<?php echo $row_rs_prosubcat3['id_procat'];?>"><?php echo $row_rs_prosubcat3['procat_name']; ?></a>&nbsp;<b> ></b>&nbsp;<a href="index.php?mod=psc2&ipc=<?php echo $row_rs_prosubcat3['id_procat'];?>&ipsc1=<?php echo $row_rs_prosubcat3['id_prosubcat1'];?>"><?php echo $row_rs_prosubcat3['prosubcat1_name']; ?></a>&nbsp;<b> ></b>&nbsp;<?php echo $row_rs_prosubcat3['prosubcat2_name']; ?></span></div>
<div class="cates">
        	<fieldset>            
