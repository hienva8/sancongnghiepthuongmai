...
$query_rs_products = sprintf("SELECT p.id_products,id_procat,p.id_member,p.product_name,p.product_name_EN,p.product_short_describe,p.product_short_describe_EN,p.product_image_illustrate,p.id_member,mb.member_kind,ct.country_name,ct.country_name_EN,ct.country_image_illustrate,cp.company_name FROM products AS p,member AS mb, country AS ct,company AS cp WHERE  p.product_type='sell' AND p.id_member=mb.id_member AND mb.member_id_country=ct.id_country AND mb.id_member=cp.id_company AND p.id_procat=%s AND  p.id_prosubcat1=%s AND p.id_prosubcat2=%s AND p.id_prosubcat3=%s", GetSQLValueString($get_id_procat_rs_products, "int"),GetSQLValueString($get_id_prosubcat1_rs_products, "int"),GetSQLValueString($get_id_prosubcat2_rs_products, "int"),GetSQLValueString($get_id_prosubcat3_rs_products, "int"));
