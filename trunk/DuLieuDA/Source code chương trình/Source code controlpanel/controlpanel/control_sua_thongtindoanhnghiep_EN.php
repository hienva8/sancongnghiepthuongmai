...
<form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" enctype="multipart/form-data">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    <tr>
      ...
      <td><input type="text" name="company_name_EN" id="company_name_EN" value="<?php echo KT_escapeAttribute($row_rscompany['company_name_EN']); ?>" size="50" />
...
do {  
?>
        <option value="<?php echo $row_rs_country['id_country']?>"<?php if (!(strcmp($row_rs_country['id_country'], $row_rscompany['company_id_country']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rs_country['country_name_EN']?></option>
<?php
...
do {  
?>
        <option value="<?php echo $row_rs_industry['id_industry']?>"<?php if (!(strcmp($row_rs_industry['id_industry'], $row_rscompany['company_id_industry']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rs_industry['industry_name_EN']?></option>
<?php
...
?>
    ...
    <tr>
      ...
      <td><select name="company_year_foundation" id="company_year_foundation">
        ...
        <option value="<?php echo $i;?>" <?php if (!(strcmp($i, KT_escapeAttribute($row_rscompany['company_year_foundation'])))) {echo "SELECTED";} ?>><?php echo $i;?></option>		<?php }?>
      </select>
...
do {  
?>
        <option value="<?php echo $row_rs_import_export['id_import_export']?>"<?php if (!(strcmp($row_rs_import_export['id_import_export'], $row_rscompany['company_export_rates']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rs_import_export['content_EN']?></option>
<?php
