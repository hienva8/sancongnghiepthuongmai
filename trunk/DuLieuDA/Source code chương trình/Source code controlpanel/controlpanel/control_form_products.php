...
switch($get_mod) 
	...
	$array_search = array('Sản phẩm'=>'product','Chào bán'=>'sell','Chào mua'=>'buy');
	$search_str 	= array_search($get_products,$array_search);
?>
            <select name="product_type_<?php echo $cnt1; ?>" id="product_type_<?php echo $cnt1; ?>">
           
              <option value="<?php echo $get_products;?>" <?php if (!(strcmp("$get_products", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?> selected="selected">--<?php echo $search_str; ?>--
              </option>
              <?php foreach($array_search as $key => $value) {?>
            <option value="<?php echo $value;?>" <?php if (!(strcmp("$value", KT_escapeAttribute($row_rsproducts['product_type'])))) {echo "selected=\"selected\"";} ?>><?php echo $key;?></option>
              <?php }?>
            </select>
